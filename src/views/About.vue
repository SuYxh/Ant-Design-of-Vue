<template>
  <a-table :data-source="data">
    ...
    <a-table-column key="age" title="Age1" data-index="age" />
    <a-table-column key="address" title="Address1" data-index="address" />

    <a-table-column key="tags" title="Tags1" data-index="tags">
    ...
    <a-table-column key="action" title="Action">
      <template slot-scope="text, record">
        <span>
          ...
          <a @click="handle(record,text)">Delete</a>
        </span>
      </template>
    </a-table-column>
